...
class ProgrammingLanguagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create programming_language" do
    assert_difference("ProgrammingLanguage.count") do
      post programming_languages_url, params: { programming_language: { description: @programming_language.description, link: @programming_language.link, title: @programming_language.title } }
    end
  ...
  test "should update programming_language" do
    patch programming_language_url(@programming_language), params: { programming_language: { description: @programming_language.description, link: @programming_language.link, title: @programming_language.title } }
